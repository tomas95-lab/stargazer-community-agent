...
const DEFAULT_TEMPLATES: ComposerTemplate[] = [
  ...
  },
  {
    ...
    tone: 'friendly',
    objective: 'inform',
    extraContext: 'Mention any required breakout room only if it is listed in the project guidelines or memory.',
    includeWarRoomLink: true,
  },
  {
    ...
    prompt: 'Explain that the War Room is closed on Saturdays and Sundays and ask contributors to come back during the project support hours listed in the project guidelines or memory.',
    audience: 'Project contributors',
    channel: 'community',
  ...
  },
  {
    ...
    prompt: 'Remind contributors about an upcoming project session and ask them to attend if it applies to them.',
    audience: 'Project contributors',
    channel: 'reminder',
    tone: 'professional',
    objective: 'remind',
...
function normalizeTemplate(raw: unknown, index: number): ComposerTemplate | null {
  ...
  return {
    ...
    audience: text(record.audience) || 'Project contributors',
