  ...
  return (
    <main className="flex min-h-screen w-full max-w-full items-center justify-center overflow-x-hidden bg-background px-4 py-10">
      <div className="w-full min-w-0 max-w-md">
        <Link to="/login" className="mb-5 flex items-center justify-center gap-2 text-sm font-semibold text-foreground">
      ...
      <p className="mt-5 break-words px-2 text-center text-xs text-muted-foreground">Your personal credentials remain separate from shared project content</p>
      </div>
    </main>
  )
}
