...
test('todayDate follows the UTC calendar day', () => {
  assert.equal(todayDate(new Date('2026-07-11T02:30:00.000Z')), '2026-07-11');
  assert.equal(todayDate(new Date('2026-07-11T13:00:00.000Z')), '2026-07-11');
});

test('daily publish skips Saturdays in UTC', () => {
  ...
  assert.equal(skip?.reason, 'weekend_utc');
});
